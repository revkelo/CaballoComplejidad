...
/**
 * Controlador que gestiona las interacciones entre la vista (`Ventana`) y el modelo (`FachadaModel`) en la aplicación.
 * 
 * @author Kevin
 * @author Daniela
 * @author Nicolas
...
public class Controller implements ActionListener {
    ...
    /**
     * Constructor de la clase `Controller`. Inicializa las variables y establece los action listeners.
     */
    public Controller() {
